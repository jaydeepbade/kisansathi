...
import 'smart_crop_predictor_screen.dart';
...
class DashboardScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        actions: [
          // Voice Assistant mic button (left of notification)
          IconButton(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              // 2.5 Smart Crop Predictor Banner
              _buildSmartCropPredictor(context, isDark, loc),
  ...
  Widget _buildSmartCropPredictor(BuildContext context, bool isDark, AppLocalizations loc) {
    return GestureDetector(
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(builder: (context) => const SmartCropPredictorScreen()));
      },
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            const Text(
              'AI analyzes 10+ factors including:',
            ...
            Wrap(
              ...
              runSpacing: 6,
              children: [
                'Weather & Rainfall', 'Soil & Temp', 'Water Availability',
                'Market Demand', 'Local Mandi Prices', 'Govt Schemes',
