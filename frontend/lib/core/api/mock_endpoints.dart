...
class DiseaseScanResult {
  ...
  final List<String> organicSolutionsHI;
  ...
  DiseaseScanResult({
    ...
    this.organicSolutionsEN = const [],
    this.organicSolutionsHI = const [],
  });
  ...
  Map<String, dynamic> toJson() => {
        ...
        'organicSolutionsEN': organicSolutionsEN,
        'organicSolutionsHI': organicSolutionsHI,
      };
}
  ...
  static Future<DiseaseScanResult> detectDisease(String imagePath) async {
    ...
    final diseases = [
      DiseaseScanResult(
        ...
        organicSolutionsEN: [
          'Spray diluted neem oil (5ml/liter) every 10 days as preventive measure.',
          'Use compost tea to boost plant immunity naturally.',
          'Apply wood ash around the base to improve soil pH balance.',
        ],
        organicSolutionsHI: [
          'रोकथाम के रूप में हर 10 दिन में पतला नीम का तेल (5ml/लीटर) स्प्रे करें।',
          'पौधों की प्रतिरोधक क्षमता बढ़ाने के लिए कम्पोस्ट चाय का उपयोग करें।',
          'मिट्टी का pH संतुलित करने के लिए लकड़ी की राख डालें।',
        ],
      ),
      DiseaseScanResult(
        ...
        organicSolutionsEN: [
          'Mix 1 tsp baking soda + 1 tsp soap in 1L water and spray weekly.',
          'Plant basil near tomatoes as a natural antifungal companion crop.',
          'Use diluted garlic extract spray to suppress mold growth.',
        ],
        organicSolutionsHI: [
          '1L पानी में 1 चम्मच बेकिंग सोडा + 1 चम्मच साबुन मिलाकर साप्ताहिक स्प्रे करें।',
          'प्राकृतिक एंटिफंगल के रूप में टमाटर के पास तुलसी लगाएं।',
          'फफूंद वृद्धि रोकने के लिए पतला लहसुन का अर्क स्प्रे करें।',
        ],
      ),
      DiseaseScanResult(
        ...
        organicSolutionsEN: [
          'Apply fermented cow urine (Gomutra) diluted 1:10 as a natural fungicide.',
          'Use Trichoderma viride bio-fungicide mixed in compost.',
          'Rotate with legume crops (chickpea/lentil) to break disease cycle.',
        ],
        organicSolutionsHI: [
          'प्राकृतिक फफूंदनाशी के रूप में 1:10 पतला किण्वित गोमूत्र लगाएं।',
          'खाद में मिला ट्राइकोडर्मा विरिडे बायो-फफूंदनाशी का उपयोग करें।',
          'रोग चक्र तोड़ने के लिए दलहनी फसलों (चना/मसूर) के साथ फसल चक्र अपनाएं।',
        ],
      ),
    ];
